...
urlpatterns = [
    ...
    path('<int:site_id>/meta/convert-permalinks/', views.convert_permalinks, name='convert_permalinks'),
    path('<int:site_id>/meta/convert-permalinks/start/', views.start_convert_permalinks, name='start_convert_permalinks'),
    path('<int:site_id>/meta/convert-permalinks/status/', views.check_convert_permalinks_status, name='check_convert_permalinks_status'),
    path('<int:site_id>/meta/convert-permalinks/clear/', views.clear_convert_permalinks_status, name='clear_convert_permalinks_status'),
    path('<int:site_id>/meta/convert-permalinks/fetch-files-v2/', views.fetch_files_v2, name='fetch_files_v2'),
    path('<int:site_id>/meta/convert-permalinks/fetch-files-v2/status/', views.check_fetch_files_v2_status, name='check_fetch_files_v2_status'),
    path('<int:site_id>/meta/convert-permalinks/fetch-files-v2/clear/', views.clear_fetch_files_v2_status, name='clear_fetch_files_v2_status'),
